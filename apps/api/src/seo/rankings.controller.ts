...
import { CheckRankingsDto, GetRankingsDto, GetRankingSummaryDto } from './dto/ranking.dto';
...
export class RankingsController {
    ...
    async checkRankings(
        ...
        return this.rankingsService.checkRankings(projectId, organizationId, dto.keywordIds);
    }
    ...
    async getSummary(
        ...
        const organizationId = req.user.organizationId || 'default-org-id';
        return this.rankingsService.getRankingSummary(projectId, organizationId, query.days);
    }
}
