...
export class CompetitorsService {
    ...
    async createCompetitor(
        ...
        console.log(`[CompetitorsService] Creating competitor for project ${projectId}, org ${organizationId}`);
        ...
        try {
            ...
            console.log(`[CompetitorsService] Competitor created with ID: ${competitor.id}`);
            return competitor;
        } catch (error) {
            console.error(`[CompetitorsService] Failed to create competitor: ${error.message}`);
            throw error;
        }
    }

    async getCompetitors(projectId: string, organizationId: string, filters?: any) {
        const where = {
            projectId,
            organizationId,
        };
    ...
    async updateCompetitor(
        ...
        const competitor = await this.getCompetitorById(competitorId, organizationId);
